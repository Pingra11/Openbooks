...
window.verifyUserAccount = async function() {
  ...
  try {
    ...
    // Debug: log security questions structure
    console.log('Security questions data:', JSON.stringify(securityQuestionsObj, null, 2));
    
    // Check for security questions - support multiple formats
    const hasQuestion1 = securityQuestionsObj.question1 && 
      (securityQuestionsObj.question1.question || securityQuestionsObj.question1.answerHash || securityQuestionsObj.question1.answer);
    const hasQuestion2 = securityQuestionsObj.question2 && 
      (securityQuestionsObj.question2.question || securityQuestionsObj.question2.answerHash || securityQuestionsObj.question2.answer);
    const hasQuestion3 = securityQuestionsObj.question3 && 
      (securityQuestionsObj.question3.question || securityQuestionsObj.question3.answerHash || securityQuestionsObj.question3.answer);
    
    console.log('Has questions:', { hasQuestion1, hasQuestion2, hasQuestion3 });
    
    if (!hasQuestion1 || !hasQuestion2 || !hasQuestion3) {
      console.log('Missing security questions - q1:', !!hasQuestion1, 'q2:', !!hasQuestion2, 'q3:', !!hasQuestion3);
